    ...
    <footer className="bg-zinc-100 border-t-[1px] border-t-gray-400 py-7">
      <div className="flex items-center justify-center gap-5">
        ...
        <div className="flex items-center gap-5">
          ...
          <a href="https://itunes.apple.com/in/app/id989540920?referrer=utm_source%3Dswiggy%26utm_medium%3Dhomepage" target="_blank">
      ...
      <div className="flex justify-center flex-wrap gap-12">
        ...
        <div className="p-2">
          ...
          <ul>
            <li className="text-md text-gray-600 font-medium mb-3">About Us</li>
            <li className="text-md text-gray-600 font-medium mb-3">
              Swiggy Corporate
            </li>
            <li className="text-md text-gray-600 font-medium mb-3">Careers</li>
            ...
            <li className="text-md text-gray-600 font-medium">Swiggy Genie</li>
          </ul>
        </div>
        <div className="p-2">
          ...
          <ul>
            ...
            <li className="text-md text-gray-600 font-medium">Ride with us</li>
          </ul>
        ...
        <div className="p-2">
          ...
          <ul>
            <li className="text-md text-gray-600 font-medium mb-3">Lucknow</li>
            <li className="text-md text-gray-600 font-medium mb-3">Gurgaon</li>
            ...
            <li className="text-md text-gray-600 font-medium mb-3">Mmumbai</li>
